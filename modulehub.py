...
class ModuleHubMod(loader.Module):
    ...
    MODULES = {
        ...
        "groupadmin": {
            ...
            "name": "GroupAdmin",
            "icon": "🛡",
            "description": "Панель адміністрування, покарання, warns, slow mode і дозволи.",
        },
        "minigames": {
            "class": "MiniGamesMod",
            "name": "MiniGames",
        ...
        "giftmonitor": {
            ...
            "name": "GiftMonitor",
            "icon": "💎",
            "description": "Моніторинг NFT-подарунків на офіційному Telegram-маркеті.",
        },
        "hiddengifts": {
