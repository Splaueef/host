...
камінь–ножиці–папір із прихованим вибором, кубик-дуель, шашки 8×8 і швидку
вікторину. У шашках підтримуються обов'язкове взяття, серії взяттів, удари
назад звичайною шашкою та «літаючі» дамки. Завершені матчі потрапляють у
локальний рейтинг чату. Меню відкривається командою `.games`; суперника можна
запросити відповіддю або через `@username`.
