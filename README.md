...
правило 50 ходів і триразове повторення позиції. Шахова панель має координати,
контрастні клітинки, підсвічування ходів, перевертання дошки та підтвердження
завершення партії; у HikkaNet чорні автоматично бачать свою сторону знизу.
